...
query1 <- paste0("SELECT i.deployment, t.datetime, t.pm10, t.pm25, ", 
                 ...
                 t.datetime - '1 hour'::interval, t.datetime) ", 
                 "AS invalid_pm25, ",
                 "flags.is_invalid(t.deployment_id, 320, 
                 t.datetime - '1 hour'::interval, t.datetime) ", 
                 "AS invalid_bp, ",
                 "flags.is_invalid(t.deployment_id, 150, 
                 t.datetime - '1 hour'::interval, t.datetime) ", 
                 "AS invalid_at, ",
                 "flags.is_invalid(t.deployment_id, 151, 
                 t.datetime - '1 hour'::interval, t.datetime) ", 
                 "AS invalid_rh ",
...
query1 <- paste0("SELECT i.deployment, m.datetime, ",
                 ...
                 "flags.is_invalid(m.deployment_id, 114, 
                 m.datetime - '1 hour'::interval, m.datetime) ", 
                 "AS invalid_ws, ",
                 "flags.is_invalid(m.deployment_id, 298, 
                 m.datetime - '1 hour'::interval, m.datetime) ", 
                 "AS invalid_wd, ",
                 "flags.is_invalid(m.deployment_id, 118,
                 m.datetime - '1 hour'::interval, m.datetime) ", 
                 "AS invalid_rad, ",
                 "flags.is_invalid(m.deployment_id, 119,
                 m.datetime - '1 hour'::interval, m.datetime) ", 
                 "AS invalid_at, ",
                 "flags.is_invalid(m.deployment_id, 120,
                 m.datetime - '1 hour'::interval, m.datetime) ", 
                 "AS invalid_rh, ",
                 "flags.is_invalid(m.deployment_id, 115,
                 m.datetime - '1 hour'::interval, m.datetime) ", 
                 "AS invalid_d2, ",
                 "flags.is_invalid(m.deployment_id, 116,
                 m.datetime - '1 hour'::interval, m.datetime) ", 
                 "AS invalid_d10 ",
